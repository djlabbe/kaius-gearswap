...
function user_setup()
    ...
    if player.sub_job == 'SAM' then
        ...
        send_command('bind ^numpad4 gs c set WeaponSet Mafic;input /macro set 3')
        set_macro_page(1, 14)
    elseif player.sub_job == 'WAR' then
        ...
        send_command('bind ^numpad9 gs c set WeaponSet Naegling;input /macro set 5')
        send_command('bind ^numpad4 gs c set WeaponSet Mafic;input /macro set 6')
        set_macro_page(4, 14)
