...
function user_setup()
    ...
    send_command('bind ^numpad8 gs c set WeaponLock false;gs c set WeaponSet Twashtar; gs c set WeaponLock true;input /macro set 2')
    send_command('bind ^numpad9 gs c set WeaponLock false;gs c set WeaponSet Tauret; gs c set WeaponLock true;input /macro set 2')
    send_command('bind ^numpad4 gs c set WeaponLock false;gs c set WeaponSet Carnwenhan; gs c set WeaponLock true;input /macro set 2')
