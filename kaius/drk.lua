...
function user_setup()
    ...
    state.WeaponSet = M{['description']='Weapon Set', 'Caladbolg', 'Helheim', 'Apocalypse', 'Loxotic', 'Lycurgos', 'Naegling'}
    ...
    if player.sub_job == 'SAM' then
        send_command('bind ^numpad7 gs c set WeaponLock false;gs c set WeaponSet Caladbolg; gs c set WeaponLock true;input /macro set 1')
        send_command('bind ^numpad8 gs c set WeaponLock false;gs c set WeaponSet Helheim; gs c set WeaponLock true;input /macro set 1')
        send_command('bind ^numpad9 gs c set WeaponLock false;gs c set WeaponSet Apocalypse; gs c set WeaponLock true;input /macro set 2')
        send_command('bind ^numpad4 gs c set WeaponLock false;gs c set WeaponSet Lycurgos; gs c set WeaponLock true;input /macro set 3')
        send_command('bind ^numpad6 gs c set WeaponLock false;gs c set WeaponSet Naegling; gs c set WeaponLock true;input /macro set 4')
        send_command('bind ^numpad5 gs c set WeaponLock false;gs c set WeaponSet Loxotic; gs c set WeaponLock true;input /macro set 5')
        set_macro_page(1, 8)
    elseif player.sub_job == 'DRG' then   
        send_command('bind ^numpad7 gs c set WeaponLock false;gs c set WeaponSet Caladbolg; gs c set WeaponLock true;input /macro set 6')
        send_command('bind ^numpad8 gs c set WeaponLock false;gs c set WeaponSet Helheim; gs c set WeaponLock true;input /macro set 6')
        send_command('bind ^numpad9 gs c set WeaponLock false;gs c set WeaponSet Apocalypse; gs c set WeaponLock true;input /macro set 7')
        send_command('bind ^numpad4 gs c set WeaponLock false;gs c set WeaponSet Lycurgos; gs c set WeaponLock true;input /macro set 8')
        send_command('bind ^numpad6 gs c set WeaponLock false;gs c set WeaponSet Naegling; gs c set WeaponLock true;input /macro set 9')
        send_command('bind ^numpad5 gs c set WeaponLock false;gs c set WeaponSet Loxotic; gs c set WeaponLock true;input /macro set 10')
        set_macro_page(6, 8)
    else
        send_command('bind ^numpad7 gs c set WeaponLock false;gs c set WeaponSet Caladbolg; gs c set WeaponLock true;input /macro set 6')
        send_command('bind ^numpad8 gs c set WeaponLock false;gs c set WeaponSet Helheim; gs c set WeaponLock true;input /macro set 6')
...
function init_gear_sets()
    ...
    sets.precast.WS['Catastrophe'] = set_combine({
        ammo="Knobkierrie",
        head=gear.Nyame_Head, 
    ...
    sets.precast.WS['Insurgency'] = set_combine({
        ammo="Knobkierrie",
        head=gear.Empyrean_Head,
        body=gear.Nyame_Body,
        hands=gear.Sakpata_Hands,
    ...
    sets.precast.WS['Quietus'] = set_combine({
        ammo="Knobkierrie",
        head=gear.Nyame_Head,
        body=gear.Nyame_Body,
        hands=gear.Nyame_Hands,
    ...
    sets.precast.WS['Infernal Scythe'] = set_combine({
        ammo="Knobkierrie",
        head="Pixie Hairpin +1",
        body=gear.Nyame_Body,
        hands=gear.Nyame_Hands,
    ...
    sets.precast.WS['Torcleaver'] = set_combine({
        ammo="Knobkierrie", --6
    ...
    sets.Naegling = { main="Drepanum", sub="Blurred Shield +1" }
