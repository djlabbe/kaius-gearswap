...
state.WeaponMode:options('Heishi_Gleti','Heishi_Darkblade','Naegling','Aeolian Edge','Unlocked')
...
function get_sets()
	...
	sets.Weapons['Aeolian Edge'] = {main="Tauret",sub="Naegling"}
