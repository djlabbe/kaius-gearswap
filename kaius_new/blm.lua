...
function get_sets()
	...
	sets.Precast.FastCast = {
        ...
        hands="Agwu's Gages",
        legs="Agwu's Slops",
        feet={name="Merlinic Crackows", augments={'"Mag.Atk.Bns."+21','"Fast Cast"+7','CHR+6','Mag. Acc.+7',}},
	...
	sets.Midcast.Enhancing = {
        ...
        feet={name="Telchine Pigaches", augments={'Mag. Evasion+19','"Conserve MP"+4','Enh. Mag. eff. dur. +10',}},
	...
	sets.Idle.Town = sets.Midcast.Burst
